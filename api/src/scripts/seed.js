...
async function main() {
  await pool.query("INSERT INTO companies (name, domain, app_domain, api_domain, plan) VALUES ('Cálculo Light','www.calculight.com','app.calculolight.com','api.calculolight.com','Profissional') ON CONFLICT DO NOTHING");
